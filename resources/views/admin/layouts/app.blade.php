...
<!--begin::Head-->
<head><base href=""/>
    <title>Randevu - @yield('title')</title>
    <meta charset="utf-8" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5">
                                                    ...
                                                    <a href="https://preview.keenthemes.com/metronic8/layout-builder.html" class="btn btn-sm btn-primary fw-bold">Try Builder</a>
                                                </div>
                                                <!--end:Layout Builder-->
                                            </div>
                                            <!--end:Col-->
                    ...
                    <div class="mb-0">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
                                    ...
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo1" class="btn btn-sm btn-success shadow">Metronic Original</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="assets/media/demos/demo24.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo24" class="btn btn-sm btn-success shadow">Demo 24</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
